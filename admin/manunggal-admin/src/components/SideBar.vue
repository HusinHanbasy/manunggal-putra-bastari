  ...
  <aside class="
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href="">
        <span class="font-weight-bold text-lg">Manunggal<br />Putra Bersari</span>
      </a>
    </div>
    <div class="collapse navbar-collapse px-4 w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="#" @click.prevent="$router.push('/dashboard')">
            <div class="
        ...
        <li class="nav-item">
          <a class="nav-link" href="" @click.prevent="$router.push('/campaign')">
            <div class="
                icon icon-shape icon-sm
                px-0
                text-center
        ...
        <li class="nav-item">
          <a class="nav-link" href="" @click.prevent="$router.push('/status')">
            <div class="
                icon icon-shape icon-sm
                px-0
                text-center
        ...
        <li class="nav-item">
          <a class="nav-link" href="" @click.prevent="$router.push('/donatur')">
            <div class="
                icon icon-shape icon-sm
                px-0
                text-center
        ...
        <li class="nav-item">
          <a class="nav-link" href="" @click.prevent="$router.push('/histories')">
            <div class="
                icon icon-shape icon-sm
                px-0
                text-center
        ...
        <li class="nav-item border-start my-0 pt-2">
          <div class="nav-link position-relative ms-0 ps-2 py-2">
            <span>{{ username }} >> {{ role }}</span>
          </div>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2" href="" @click.prevent="handleLogout()">
